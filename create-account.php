     ...
     <div id = "createacct">
      <form method = "post" action="add-account.php">
          ...
          <div id = "l2">
            <p>Username</p>
            <p>
              <input name = "username" type = "username" class="required" id = "user2" />
            </p>
            <p>Password</p>
            <p>
              <input name = "password" type = "password" class="required" id = "user2" />
           </p>
          ...
          <div id = "l2">
            ...
            <p>
              <input
				name="address" type="text" class="required" id="user2" />
              <br />
            </p>
             <p>Birthdate</p>
            <p>
...
<br />
            ...
            <p>
<input type="text"
				name="occupation" id="user2" />
              </p>
             <p>Telephone No.</p>
            <p>
<input type="text"
				name="telephone" id="user2" />
              </p>
