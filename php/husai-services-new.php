...
<body>
        ...
        <div id = "content-left">
			<table id = "page-title">
                <tr>
                    ...
                    <td>Services &raquo; What's New?</td>
                </tr>
            </table>
            ...
            <table width="560" border="2" cellspacing="15" cellpadding="0" id = "search-result">
                <tr>
                    <td > <div> <img src = "../images/sample.jpg"> </div> <p> service desc </p> </td>
                    <td > <div> <img src = "../images/sample.jpg"> </div> <p> service desc </p> </td>
                    <td > <div> <img src = "../images/sample.jpg"> </div> <p> service desc </p> </td>
                </tr>
                  <tr>
    ...
    <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content-right" -->
        <div id = "content-right"> 
        	<div>            	
            	<ul>
                	<li><a href = "husai-services-new.php">&raquo; What's New?</a></li>
                    <li><a href = "husai-services-special.php">&raquo; Special / Discounted Offers</a></li>
                    <li><a href = "husai-services-face.php">&raquo; Face</a></li>
                    <li><a href = "husai-services-body.php">&raquo; Body</a></li>
                    <li><a href = "husai-services-hair.php">&raquo; Hair</a></li>                      
                </ul>
            </div>            
        </div>
        <!-- InstanceEndEditable -->
