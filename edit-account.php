...
$result = mysql_query("SELECT * FROM account where Username = '".$_SESSION['session_user']."'");
...
while($row = mysql_fetch_array($result))
{
	...
	$user_busAd = $row['Business_Address'];
	$user_busPhone = $row['Business_Phone'];
	$user_civilStat = $row['Civil_Status'];
	$user_occupation = $row['Occupation'];
	$user_referred = $row['Referred_by'];
}
     ...
     <div id = "createacct">
      <form method = "post" action="add-account.php">
          ...
          <div id = "l2">
            <p>Username</p>
            <p>
              <input name = "username" type = "username" class="required" id = "user2" readonly="readonly" value=<?php echo $user_username;?>/>
            </p>
            <p>Password</p>
            <p>
              <input name = "password" type = "password" class="required" id = "user2" value=<?php echo $user_password;?>/>
           </p>
             <p>Re-enter Password</p>
            <p>
              <input name = "password2" type = "password" class="required" id = "user2" />
            </p>            
          </div>
          ...
          <div id = "l2">
            ...
            <p>
              <input name="name" type="text" class="required"
				id="user2" value=<?php echo $name;?>/>
            </p>
            <p>Address</p>
            <p>
              <input
				name="address" type="text" class="required" id="user2" value=<?php echo $user_address;?>/>
              <br />
            </p>
             <p>Birthdate</p>
            <p>
              <select name="bmonth" class="date"
				id="bmonth">
			...
			?>
			</select> <label for="byear"></label> <select name="byear" class="date" id="byear">
			<?php
			for($i=1980; $i<=2000; $i++){
				echo "<option>".$i."</option>";
			}
...
<br />
            ...
            <p>
              <select
				name="civilStatus" id="user2" value=<?php echo $user_username;?>>
            ...
            <p>
<input type="text"
				name="occupation" id="user2" value=<?php echo $user_occupation;?>/>
              </p>
             <p>Telephone No.</p>
            <p>
<input type="text"
				name="telephone" id="user2" value=<?php echo $user_telephone;?>/>
              </p>
          ...
          <div id = "l2">
            ...
            <p>
              <input type = "username" name = "businessAd" id = "user2" value=<?php echo $user_busAd;?>/>
            </p>
            <p>Business Contact No.</p>
            <p>
              <input type = "text" name = "businessPhone" id = "user2" value=<?php echo $user_busPhone;?>/>
            </p>
             <p>Referred by</p>
            <p>
              <input type = "text" name = "referredby" id = "user2" value=<?php echo $user_referred;?>/>
            </p>
            <p><br />
            </p>
            <p align="center">
              <input type = "submit"  value = "edit account" name="submit" id ="submit" />
            </p>
          </div>
