	...
	if(isset($_POST['product_bought_searchfield'])&&isset($_POST['product_bought_search_cat'])){
		...
		if($product_bought_search_cat=="Product"){
			if($product_bought_searchfield!=""){
				$query = "SELECT bought_product.date, product.product_name, bought_product.quantity, product.category from bought_product join product on product.id=bought_product.product_id where bought_product.username='".$user."' and product.product_name like '%".$product_bought_searchfield."%' order by product.product_name";
			}else{
			...
			if($product_bought_searchfield!=""){
				$query = "SELECT bought_product.date, product.product_name, bought_product.quantity, product.category from bought_product join product on product.id=bought_product.product_id where bought_product.username='".$user."' and bought_product.date like '%".$product_bought_searchfield."%' order by bought_product.date desc";
			}else{
			...
			if($product_bought_searchfield!=""){
				$query = "SELECT bought_product.date, product.product_name, bought_product.quantity, product.category from bought_product join product on product.id=bought_product.product_id where bought_product.username='".$user."' and product.category like '%".$product_bought_searchfield."%' order by product.category";
			}else{
