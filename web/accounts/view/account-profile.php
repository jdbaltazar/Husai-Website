        ...
        <div id = "content-left-admin">
       	  <table width="929" id = "page-title">
            	<tr>
                    ...
                    <td width="119" id = "viewSP"><?php  echo '<a href = "../../services-availed/index.php?id='.$user_id.'&name='.$name.'">'?>Services Availed</a></td>
                    <td width="134" id = "viewSP"><?php  echo '<a href = "../../products-bought/index.php?id='.$user_id.'&name='.$name.'">'?>Products Bought</a></td>
                </tr>
            </table>
    <p>&nbsp;</p>
