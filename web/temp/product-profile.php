            	...
            	<form method = "" action = "" name = "myform" id = "profile-form">          
	                ...
	                <table cellspacing="15">
	                    <tr>
	                        ...
	                        <td><input type = "text" name = "product-name"  id = "s1" /></td>
	                    </tr>
	                    <tr>
	                        <td align="right" >Description:</td>
	                        <td><input type = "text" name = "product-description" id = "s1"></td>
	                    </tr>
	                    <tr>
	                    ...
	                    <tr>
	                        ...
	                        <td ><input type="text" name = "product-price" value = "" id = "s3"></td>
	                    </tr>
                        <tr>
	            		...
	            		<tr>
	            			...
	            			<td>
	            				<select id = "s3" onchange="promo(this.form);">
