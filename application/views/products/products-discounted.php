		...
		<div id="content-left">
			...
			<table width="530" border="2" cellspacing="15" cellpadding="0"
				...
				while($row = mysql_fetch_array($result)){
					...
					$image = $row["File_Path"];
					echo '<td > <div> <img src = '.$image.'></div> <p><span style="font-weight:bold;">'.$row["Product_Name"].'</span> <br/> <span style="font-style:italic;">P'.$row["Price"].'('.$row["Discount"].'% off)<span></p> </td>';
