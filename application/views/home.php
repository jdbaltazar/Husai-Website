		...
		<div id="content-left">
			...
			<div id="about-div1">
				<p id="newsheader">
					<table width="379">
						<tr>
							<td width="150" align="left" style="font-weight: bold">News &
								Events</td>
							<td width="217" align="right" style="font-size: 16px"><script
		...
		<div id="content-right">
			<div id="login-head">
				<table width="124" cellpadding="10">
					<tr>
						<td>M<span>EMBER</span> L<span>OGIN</span>
						</td>
			...
			<div id="login-div">
				<form name="login_form" method="post"
					action="../actions/authenticate.php">
					<p>User ID:</p>
				...
				<a href="membership"> How do I become a member? </a>
			</div>
