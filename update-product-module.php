...
mysql_select_db("husai", $con);
	...
	$update_acct = "update account set password='$password', type='$type', status='$status', name='$name', address='$address', birthdate='$bdate', sex='$sex', telephone='$telephone', 
	business_address='businessAd', business_phone='$businessPhone', civil_status='$civilStatus', occupation='$occupation', referred_by='$referredby'";
