        ...
        <div id = "content-left">
        	   <table id = "page-title">
            	<tr>
                    ...
                    <td>Manage Products &raquo; Special / Discounted Products  </td>
                </tr>
            </table>
            <p>&nbsp;</p>
        
            <p id = "subtitle">ADD SPECIAL OFFERS</p>
        ...
        <div id = "content-right"> 
        	<div>            	
            	<ul>
                    ...
                    <li><a href = "manage-products-face.php">&raquo; Face</a></li>
                    <li><a href = "manage-products-body.php">&raquo; Body</a></li>
